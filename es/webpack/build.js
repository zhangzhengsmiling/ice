...
var MODE = webpack_config_1.EnumEnvironment.PRODUCTION;
var build = function () { return __awaiter(void 0, void 0, void 0, function () {
    var config, compilation;
            ...
            case 1:
                ...
                compilation.run(function (err, stats) {
                    ...
                    assets.forEach(function (item) {
                        console.log("".concat(item.name, "    ").concat(chalk_1.default.yellow(item.size + ' Bytes')));
                    });
                    console.log('build successfully!!');
                    console.log(chalk_1.default.yellow('building process costs ' + (stats.endTime - stats.startTime) + 'ms'));
                });
                return [2 /*return*/];
        }
    });
